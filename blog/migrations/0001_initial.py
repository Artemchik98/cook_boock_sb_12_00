# Generated by Django 3.1.4 on 2020-12-12 08:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_point_text', models.TextField(verbose_name='Текст пункта')),
                ('post_point_image', models.ImageField(blank=True, upload_to=blog.models.save_image, verbose_name='Изображение пункта')),
